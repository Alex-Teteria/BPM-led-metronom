...
- Семплування здійснюється з використанням PIO (або еквівалентного апаратного таймера)
...
- стабільну тривалість фрейма
- відсутність накопичуваного дрейфу часу
- відтворюваність параметрів при підборі FRAME_SIZE

Менш затратні методи (IRQ таймер, ADC DMA) можливі, якщо вони гарантують фіксований інтервал семплування.
...
Система є енергетично-орієнтованим, адаптивним beat/BPM-детектором з мінімальними вимогами до апаратної частини та високою стійкістю до варіацій сигналу.
